...
public class TextAlignmentUtils {
    ...
    public static void justifyTextInLine(final @NotNull Spannable spannable, TextView textView) {
    ...
    private static class ScaleSpan extends MetricAffectingSpan {

        private final float mProportion;

        private ScaleSpan(final float proportion) {
