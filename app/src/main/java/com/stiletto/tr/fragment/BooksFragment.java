...
public class BooksFragment extends Fragment implements FileSeekerCallback, BookItemListener {
    ...
    @Override
    public void remove(Book book, int position) {
