...
public class HamButton extends BoomButton {
    ...
    private HamButton(HamButton.Builder builder, Context context) {
        super(context);
        this.context = context;
        init(builder);
    }

    private void init(HamButton.Builder builder) {
    ...
    private void initAttrs(HamButton.Builder builder) {
    ...
    public static class Builder extends BoomButtonBuilder {
         ...
         * @return the builder
         */
        public HamButton.Builder index(int index) {
            this.index = index;
            return this;
        }
         ...
         * @return the builder
         */
        public HamButton.Builder innerListener(InnerOnBoomButtonClickListener listener) {
         ...
         * @return the builder
         */
        public HamButton.Builder listener(OnBMClickListener onBMClickListener) {
         ...
         * @return the builder
         */
        public HamButton.Builder rotateImage(boolean rotateImage) {
         ...
         * @return the builder
         */
        public HamButton.Builder containsSubText(boolean containsSubText) {
         ...
         * @return the builder
         */
        public HamButton.Builder shadowEffect(boolean shadowEffect) {
         ...
         * @return the builder
         */
        public HamButton.Builder shadowOffsetX(int shadowOffsetX) {
         ...
         * @return the builder
         */
        public HamButton.Builder shadowOffsetY(int shadowOffsetY) {
         ...
         * @return the builder
         */
        public HamButton.Builder shadowRadius(int shadowRadius) {
         ...
         * @return the builder
         */
        public HamButton.Builder shadowCornerRadius(int shadowCornerRadius) {
         ...
         * @return the builder
         */
        public HamButton.Builder shadowColor(int shadowColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder normalImageRes(int normalImageRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedImageRes(int highlightedImageRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableImageRes(int unableImageRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder normalImageDrawable(Drawable normalImageDrawable) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedImageDrawable(Drawable highlightedImageDrawable) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableImageDrawable(Drawable unableImageDrawable) {
         ...
         * @return the builder
         */
        public HamButton.Builder imageRect(Rect imageRect) {
         ...
         * @return the builder
         */
        public HamButton.Builder imagePadding(Rect imagePadding) {
         ...
         * @return the builder
         */
        public HamButton.Builder normalTextRes(int normalTextRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedTextRes(int highlightedTextRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableTextRes(int unableTextRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder normalText(String normalText) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedText(String highlightedText) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableText(String unableText) {
         ...
         * @return the builder
         */
        public HamButton.Builder normalTextColor(int normalTextColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedTextColor(int highlightedTextColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableTextColor(int unableTextColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder textRect(Rect textRect) {
         ...
         * @return the builder
         */
        public HamButton.Builder textPadding(Rect textPadding) {
         ...
         * @return the builder
         */
        public HamButton.Builder typeface(Typeface typeface) {
         ...
         * @return the builder
         */
        public HamButton.Builder maxLines(int maxLines) {
         ...
         * @return the builder
         */
        public HamButton.Builder textGravity(int gravity) {
         ...
         * @return the builder
         */
        public HamButton.Builder ellipsize(TextUtils.TruncateAt ellipsize) {
         ...
         * @return the builder
         */
        public HamButton.Builder textSize(int textSize) {
         ...
         * @return the builder
         */
        public HamButton.Builder subNormalTextRes(int subNormalTextRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder subHighlightedTextRes(int subHighlightedTextRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder subUnableTextRes(int subUnableTextRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder subNormalText(String subNormalText) {
         ...
         * @return the builder
         */
        public HamButton.Builder subHighlightedText(String subHighlightedText) {
         ...
         * @return the builder
         */
        public HamButton.Builder subUnableText(String subUnableText) {
         ...
         * @return the builder
         */
        public HamButton.Builder subNormalTextColor(int subNormalTextColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder subHighlightedTextColor(int subHighlightedTextColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder subUnableTextColor(int subUnableTextColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder subTextRect(Rect subTextRect) {
         ...
         * @return the builder
         */
        public HamButton.Builder subTextPadding(Rect subTextPadding) {
         ...
         * @return the builder
         */
        public HamButton.Builder subTypeface(Typeface subTypeface) {
         ...
         * @return the builder
         */
        public HamButton.Builder subMaxLines(int subMaxLines) {
         ...
         * @return the builder
         */
        public HamButton.Builder subTextGravity(int subTextGravity) {
         ...
         * @return the builder
         */
        public HamButton.Builder subEllipsize(TextUtils.TruncateAt subEllipsize) {
         ...
         * @return the builder
         */
        public HamButton.Builder subTextSize(int subTextSize) {
            this.subTextSize = subTextSize;
            return this;
        }

        /**
         * Whether the boom-button should have a btn_background_1 effect.
         *
         * @param rippleEffect the btn_background_1 effect
         * @return the builder
         */
         ...
         * @return the builder
         */
        public HamButton.Builder normalColor(int normalColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder normalColorRes(int normalColorRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedColor(int highlightedColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder highlightedColorRes(int highlightedColorRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableColor(int unableColor) {
         ...
         * @return the builder
         */
        public HamButton.Builder unableColorRes(int unableColorRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder pieceColorRes(int pieceColorRes) {
         ...
         * @return the builder
         */
        public HamButton.Builder unable(boolean unable) {
            this.unable = unable;
            return this;
        }
         ...
         * @return the builder
         */
        public HamButton.Builder buttonWidth(int buttonWidth) {
         ...
         * @return the builder
         */
        public HamButton.Builder buttonHeight(int buttonHeight) {
         ...
         * @return the builder
         */
        public HamButton.Builder buttonCornerRadius(int buttonCornerRadius) {
