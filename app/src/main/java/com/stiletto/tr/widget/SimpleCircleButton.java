...
public class SimpleCircleButton extends BoomButton {
    ...
    private SimpleCircleButton(SimpleCircleButton.Builder builder, Context context) {
        super(context);
        this.context = context;
        init(builder);
    }

    private void init(SimpleCircleButton.Builder builder) {
    ...
    private void initAttrs(SimpleCircleButton.Builder builder) {
    ...
    public static class Builder extends BoomButtonBuilder {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder index(int index) {
            this.index = index;
            return this;
        }
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder innerListener(InnerOnBoomButtonClickListener listener) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder listener(OnBMClickListener onBMClickListener) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder rotateImage(boolean rotateImage) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder shadowEffect(boolean shadowEffect) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder shadowOffsetX(int shadowOffsetX) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder shadowOffsetY(int shadowOffsetY) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder shadowRadius(int shadowRadius) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder shadowColor(int shadowColor) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder normalImageRes(int normalImageRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder highlightedImageRes(int highlightedImageRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder unableImageRes(int unableImageRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder normalImageDrawable(Drawable normalImageDrawable) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder highlightedImageDrawable(Drawable highlightedImageDrawable) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder unableImageDrawable(Drawable unableImageDrawable) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder imageRect(Rect imageRect) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder imagePadding(Rect imagePadding) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder rippleEffect(boolean rippleEffect) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder normalColor(int normalColor) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder normalColorRes(int normalColorRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder highlightedColor(int highlightedColor) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder highlightedColorRes(int highlightedColorRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder unableColor(int unableColor) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder unableColorRes(int unableColorRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder pieceColor(int pieceColor) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder pieceColorRes(int pieceColorRes) {
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder unable(boolean unable) {
            this.unable = unable;
            return this;
        }
         ...
         * @return the builder
         */
        public SimpleCircleButton.Builder buttonRadius(int buttonRadius) {
