...
public class CategoryBarView extends View {
    ...
    CategoryFilter mIndexBarFilter;
    ...
    public void setData(CategorizedListView listView, ArrayList<String> listItems, ArrayList<Integer> listSections) {
        ...
        mIndexPaint.setColor(ContextCompat.getColor(mContext, R.color.black));
